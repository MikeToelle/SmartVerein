...
class AnniversaryOverviewController extends \TYPO3\CMS\Fluid\Core\Widget\AbstractWidgetController

{
    ...
    public function indexAction()
    {
        ...
        $anniversaries = $this->memberRepository->findAnniversary($sysSettings->getClubAnniversaries());
        $this->view->assign('anniversaries', $anniversaries);
    }
}
